...
<div class="header_top">
	<div class="web">
		<div class="welcome">
			...
			<img src="<?php echo $this->figureurl_qq_1;?>" alt="">
		</div>
		<ul class="top_tool">
			...
			<div class="body_toolbar">
				...
				<?php }else{?>
					<div class="body_toolbar_btn login_reg">
						...
						<img src="upload/QQ.png" onclick="long()">
						<em> | </em>
...
<section id="home_fouse" class="home_fouse">
	...
	<ul>
		...
		<li><a href="<?php echo IUrl::creatUrl("".$item['url']."");?>" style="background: url(<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."");?>) no-repeat center top;"></a></li>
		<?php }?>
	</ul>
	<?php }?>
</section>
...
<!-- 商城公告和新闻动态 -->
<!-- <?php $query = new IQuery("goods");$query->limit = "3";$items = $query->find(); foreach($items as $key => $item){?>
 ID:<?php echo isset($item['id'])?$item['id']:"";?>
<?php }?> -->
<!-- 广告位 -->
<section class="home_focus_show">
	<div class="show_list"><?php echo Ad::show("首页景点广告",$this->city);?></div>
...
//点击图片跳转到该方法
function long(){
	location.href="<?php echo IUrl::creatUrl("/site/long");?>";
}
