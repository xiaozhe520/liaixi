				...
				<tr>
					<td>
						<table class="list_table2" width="100%">
							...
							<tbody>
								<tr><th>商家数量</th><td><?php $query = new IQuery("seller");$query->fields = "count(*) as amount";$query->where = "is_lock = 0";$items = $query->find(); foreach($items as $key => $item){?><a href="<?php echo IUrl::creatUrl("/member/seller_list");?>"><b class="f14 red3"><?php echo isset($item['amount'])?$item['amount']:"";?></b> 家</a><?php }?></td></tr>
				...
				<tr>
					<td>
						<table class="list_table2" width="100%">
							...
							<tbody>
								<tr><th>待回复评论</th><td><a href="<?php echo IUrl::creatUrl("/comment/comment_list/search[c.recomment_time]/=0");?>"><b class="red3 f14"><?php echo statistics::commentWaitCount();?></b></a> 个</td></tr>
